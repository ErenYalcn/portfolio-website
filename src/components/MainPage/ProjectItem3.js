...
<div>
    ...
    <div className='flex items-center h-52'>
     <div className='hidden sm:block'> <div class="line2"></div></div>
      ...
      <h4 className='text-4xl font-bold opacity-60 group-hover:opacity-100 transition-all'>Twitter Klon</h4>
    ...
    <div className='w-[480px] relative'>
      ...
      <img className='w-[500px] right-0  shadow-xl top-0 z-20 relative invisible group-hover:visible transition-all transform group-hover:-translate-x-6 transition duration-700 opacity-0 group-hover:opacity-100' src="https://user-images.githubusercontent.com/57539683/154854683-6d733f0d-e92e-4ac0-88a6-8addab8252e6.png" />
