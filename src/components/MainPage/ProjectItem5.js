...
import omdb from '../../Image/omdbws.png'


export default function Projectitem5() {
  return (
    <div>
      <a href="https://github.com/ErenYalcn/erdbmovie">
    ...
    <div className='flex items-center h-52'>
     <div className='hidden sm:block'> <div class="line2"></div></div>
      ...
      <h4 className='text-2xl sm:text-4xl font-bold opacity-60 group-hover:opacity-100 transition-all max-w-[80px] sm:max-w-none'>OMDb API</h4>
    ...
    <div className='w-[480px] relative'>
      ...
      <img className='w-[500px] right-0  shadow-xl top-0 z-20 relative sm:invisible sm:group-hover:visible transition-all transform sm:group-hover:-translate-x-6 transition duration-700 sm:opacity-0 group-hover:opacity-100' src={omdb} />
